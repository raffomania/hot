defmodule HotWeb.Components.CheckboxCard do
  @moduledoc """
  The `HotWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
