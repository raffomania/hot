defmodule HotWeb.Components.CheckboxField do
  @moduledoc """
  HotWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
