defmodule HotWeb.Components.Clipboard do
  @moduledoc """
  The `HotWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
