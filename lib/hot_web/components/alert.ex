defmodule HotWeb.Components.Alert do
  @moduledoc """
  HotWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
