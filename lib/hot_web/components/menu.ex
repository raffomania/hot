defmodule HotWeb.Components.Menu do
  @moduledoc """
  The `HotWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `HotWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import HotWeb.Components.Accordion, only: [accordion: 1]
  import HotWeb.Components.Button, only: [button_link: 1]
