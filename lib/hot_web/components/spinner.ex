defmodule HotWeb.Components.Spinner do
  @moduledoc """
  The `HotWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `HotWeb.Components.Spinner` module enables developers to provide
