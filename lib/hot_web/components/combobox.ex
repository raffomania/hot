defmodule HotWeb.Components.Combobox do
  @moduledoc """
  The `HotWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
