defmodule HotWeb.Components.Tabs do
  @moduledoc """
  `HotWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import HotWeb.Components.Badge, only: [badge: 1]
