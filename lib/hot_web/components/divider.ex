defmodule HotWeb.Components.Divider do
  @moduledoc """
  The `HotWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `HotWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
