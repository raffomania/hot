defmodule HotWeb.Components.Overlay do
  @moduledoc """
  The `HotWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `HotWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
