defmodule HotWeb.Components.NativeSelect do
  @moduledoc """
  The `HotWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `HotWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HotWeb.Gettext, "errors", msg, opts)
    end
  end
end
